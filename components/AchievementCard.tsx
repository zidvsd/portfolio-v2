...
export default function AchievementCard({ data }: AchievementProps) {
  ...
  return (
    <Card className="group relative flex h-full flex-col overflow-hidden rounded-xl border p-2 shadow-md transition-all hover:border-primary/50 hover:shadow-md">
      <CardContent className="flex flex-1 flex-col p-2">
        ...
        <div className="mt-4 flex flex-1 flex-col justify-between space-y-4">
          ...
          {/* Action Button */}
          <Button variant="accent" size="icon-lg" className="w-full">
            <a
